        ...
        <div className={styles['wrapper']}>
          ...
          <div className={styles['find-info']}>
            <div
              ...
              onClick={() => history.push(RoutePaths.auth.find.index)}
            >
              아이디 / 비밀번호 찾기
            </div>
          </div>
          <div className={styles['button-box']}>
            ...
            <BasicButton
              ...
              disable={false}
              color={'gray'}
              onClick={() => history.push(RoutePaths.auth.signup)}
            />
          </div>
          <div className={styles['sns-box']}>
            <div className={styles['sns-text']}>소셜 로그인</div>
            <div className={styles['sns-icon']}>
              <IconButton
                className={styles['sns-login']}
