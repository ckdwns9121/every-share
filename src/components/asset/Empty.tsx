...
function Empty(){
    return(
       ...
       <svg width="80" height="80" viewBox="0 0 80 80">
        ...
        <g  transform="translate(-161 -603)" clip-path="url(#clip-path)">
          <g id="blank" transform="translate(161 603)">
            <g  transform="translate(10 17.1)">
              <g >
                ...
                <path  d="M31.145,27.623h12.58a3.145,3.145,0,0,0,0-6.29H31.145a3.145,3.145,0,0,0,0,6.29Zm0-4.193h12.58a1.048,1.048,0,1,1,0,2.1H31.145a1.048,1.048,0,0,1,0-2.1Z" transform="translate(-5.985 -4.56)" fill="#222" stroke="#707070" stroke-width="0.167"/>
              </g>
            </g>
